...
**Case 2 (empty first name):** Confirmed. Error message "First Name is required"
displayed, checkout blocked as expected. AI's prediction was correct.

**Case 3 (empty zip code):** Confirmed. Error message "Postal Code is required"
displayed, checkout blocked as expected. AI's prediction was correct.

**Case 4 (special characters):** I tested this against the zip code field rather
...
## Takeaway
The AI was accurate on required-field validation (cases 2 and 3) but couldn't
